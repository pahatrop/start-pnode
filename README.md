...
Tunyl allows you to securely expose local web applications, APIs, or development servers to the Internet.
...
```sh
npx tunyl@latest --token your-agent-token --port 3000
```
...
All traffic between the agent and Tunyl servers is encrypted.
...
* Website: [https://tunyl.com](https://tunyl.com)
* Documentation: [https://tunyl.com/docs](https://tunyl.com/docs)
